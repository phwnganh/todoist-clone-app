    ...
    return (
        <SettingsModalMainSectionLayout>
            ...
            <div className={"flex flex-col sm:flex-row gap-large"}>
                <button type={"button"} id={"default-theme"} aria-checked={currentTheme === "light"} onClick={() => changeTheme("light")} role={"radio"} aria-label={"default-theme"} className={"rounded-large border border-product-library-divider-primary flex overflow-hidden"}>
                    <LightThemeSelection/>
                </button>
                <button type={"button"} id={"dark-theme"} aria-checked={currentTheme === "dark"} onClick={() => changeTheme("dark")} role={"radio"} aria-label={"dark-theme"} className={"rounded-large border border-product-library-divider-primary flex overflow-hidden"}>
                    <DarkThemeSelection/>
                </button>
            </div>
        </SettingsModalMainSectionLayout>
