    ...
    return (
        <SettingsModalMainSectionLayout>
            ...
            <div className={"flex flex-col sm:flex-row gap-large"}>
                <button type={"button"} id={"default-theme"} aria-checked={theme === "light"} onClick={() => setTheme("light")} role={"radio"} aria-label={"default-theme"} className={"rounded-large border border-product-library-divider-primary flex overflow-hidden w-fit sm:w-auto"}>
                    <LightThemeSelection/>
                </button>
                <button type={"button"} id={"dark-theme"} aria-checked={theme === "dark"} onClick={() => setTheme("dark")} role={"radio"} aria-label={"dark-theme"} className={"rounded-large border border-product-library-divider-primary flex overflow-hidden w-fit sm:w-auto"}>
                    <DarkThemeSelection/>
                </button>
            </div>
        </SettingsModalMainSectionLayout>
