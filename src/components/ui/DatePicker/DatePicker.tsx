...
const DatePicker = ({value, onChange}: DatePickerProps) => {
    ...
    return (
        ...
        classNames={{
            ...
            button_previous: "hover:bg-gray-100 rounded-small flex justify-center items-center h-6 w-6",
            button_next: "hover:bg-gray-100 rounded-small flex justify-center items-center h-6 w-6",
