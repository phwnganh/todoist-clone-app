...
const EmptyInboxTasks = () => {
    ...
    return (
        <div className={"flex flex-col justify-center items-center max-w-90 w-full mx-auto"}>
            <img src={theme === "dark" ? DarkEmptyInboxTask : LightEmptyInboxTask} alt={"empty-inbox-tasks"}/>
            <p className={"my-small text-base text-product-library-display-primary-idle-tint font-medium"}>Capture now, plan later</p>
