  ...
  return (
    <>
      <label className="h-4.5 w-8 relative inline-block">
        <input type="checkbox" className={`sr-only peer ${className}`} {...props} />
        ...
        <div className="absolute top-0.75 left-0.75 h-3 w-3 rounded-full bg-product-library-background-base-primary peer-checked:translate-x-3.5"></div>
      </label>
    </>
  );
};
