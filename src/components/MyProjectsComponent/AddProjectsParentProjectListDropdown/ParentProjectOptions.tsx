...
const ParentProjectOptions = ({project, isParentProjectsSelected, onParentProjectsSelected}: ParentProjectOptionsProps) => {
    return (
        <button data-selected={isParentProjectsSelected} key={project.id} onClick={() => onParentProjectsSelected(project.name)}
