...
const MyProjectsItem = () => {
    const [isOpenMyProjectsToolbars, setIsOpenMyProjectsToolbars] = useState(false)
    ...
    return (
        <>
            ...
            <div role="button" onClick={handleToggleMyProjectsToolbars} className="group-hover:flex items-center hidden gap-1 relative">
                <IndicatorDots/>
                {isOpenMyProjectsToolbars && (<div className="absolute right-9">
                    <MyProjectsToolbarDropdown/></div>)}
            </div>
