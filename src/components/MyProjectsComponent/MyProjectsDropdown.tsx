  ...
  return (
    <>
      <div className="absolute border border-product-library-divider-primary rounded-large shadow-sm right-0 mt-1 p-1.5 min-w-55 flex flex-col gap-1 z-50">
        <button type={"button"} aria-labelledby={"open add project modal"}
          className="flex items-center min-h-8 w-full hover:bg-product-library-selectable-secondary-hover-fill rounded-small"
        ...
        <button type={"button"} className="flex items-center min-h-8 w-full hover:bg-product-library-selectable-secondary-hover-fill rounded-small">
          <div className="flex justify-center items-center mr-2.5 shrink-0">
