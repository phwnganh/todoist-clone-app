...
const MyProjectFormParentProjectListDropdown = ({
  ...
  return (
    <div
      ...
      className="absolute top-full z-1000 border border-product-library-divider-primary rounded-large shadow-sm overflow-y-auto scrollbar-thin scrollbar-custom max-h-70 w-full mt-1 bg-product-library-background-base-primary text-product-library-display-primary-idle-tint"
    >
      <SearchInput
