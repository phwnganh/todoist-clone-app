...
const MyTaskFilterDirectionDropdown = ({selectedDirection, onSelectDirection}: MyTaskFilterDirectionDropdownProps) => {
    return (
        <div id={"direction-listbox"} aria-labelledby={"direction-trigger"} role={"listbox"} className={
