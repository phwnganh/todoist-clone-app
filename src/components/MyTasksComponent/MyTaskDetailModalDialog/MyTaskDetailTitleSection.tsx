...
const MyTaskDetailTitleSection = ({sectionDetail, projectDetail, onCloseTaskDetail}: MyTaskDetailTitleSectionProps) => {
    return (
        <header className={"flex justify-between py-small px-medium border-b border-product-library-divider-tertiary"}>
            <div className={"px-2 flex items-center gap-1.5"}>
              ...
              <p className={"text-product-library-display-secondary-idle-tint font-medium text-sm"}>{sectionDetail?.name}</p>
            </span></>)}
            </div>
            <button
