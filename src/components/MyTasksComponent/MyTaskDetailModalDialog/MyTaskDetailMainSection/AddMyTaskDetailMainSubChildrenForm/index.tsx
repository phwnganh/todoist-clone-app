...
const AddMyTaskDetailMainSubChildrenForm = ({onCloseAddMySubTask, taskDetail}: AddMyTaskDetailMainSubChildrenFormProps) => {
    ...
    const subTaskFormValuesPayload = (values: MyTaskFormValues): SubTaskPayload => ({
