...
const EditMyTaskDetailMainSubChildrenForm = ({
  onCloseEditMySubTask,
  taskDetail,
}: EditMyTaskDetailMainSubChildrenFormProps) => {
  ...
  useEffect(() => {
    ...
    setValues(
      getTaskValuesByMappingDataType(
        taskDetail,
        projects?.results,
        sections?.results,
        labels?.results,
  ...
  return (
    <MyTaskForm
      onCloseMyTaskForm={onCloseEditMySubTask}
      onSubmit={handleUpdateMySubTask}
      submitLabel={"Save"}
