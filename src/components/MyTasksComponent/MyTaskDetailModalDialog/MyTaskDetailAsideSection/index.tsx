...
const MyTaskDetailAside = ({ taskDetail }: MyTaskDetailAsideProps) => {
  ...
  return (
    <aside
      className={
        "p-large mt-3 md:mt-0 md:bg-product-library-background-base-primary flex flex-col w-full gap-small md:w-80 shrink-0 border-t-6 border-t-product-library-divider-tertiary md:border-t-0"
      }
    >
