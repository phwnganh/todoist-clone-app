...
import AddMyTaskBoardSectionFinalButton
    from "../MyTaskSectionComponent/MyTaskBoardSectionComponent/AddMyTaskBoardSectionFinalButton.tsx";
import AddMyTaskSection from "../MyTaskSectionComponent/AddMyTaskSectionComponent";
import AddMyTaskBoardSectionSlot
    from "../MyTaskSectionComponent/MyTaskBoardSectionComponent/AddMyTaskBoardSectionSlot";
...
const MyTasksBoard = ({filteredSectionsByProject}: MyTasksBoardProps) => {
    ...
    const [openAddNewTaskSectionFormModalDialog, setOpenAddNewTaskSectionFormModalDialog] = useState(false);
    ...
    return (
        <section className={"flex items-start overflow-x-auto scrollbar-thin scrollbar-custom"}>
            ...
            {openAddNewTaskSectionFormModalDialog ? (
                <AddMyTaskSection onCancelAddMyTaskSection={handleCloseAddNewTaskSectionFormModalDialog}/>
            ) : (
                <AddMyTaskBoardSectionFinalButton onOpenAddNewTaskSectionForm={handleOpenAddNewTaskSectionFormModalDialog}/>
            )}
