    ...
    return (
        <form className={"flex flex-col gap-small"} onSubmit={onSubmit}>
            ...
            <div className={"flex items-center gap-small"}>
                ...
                <button type={"button"} className={"px-3 py-1.5 text-xs text-product-library-actionable-secondary-on-idle-tint rounded-small hover:bg-product-library-selectable-secondary-hover-fill"} onClick={onCancel}>Cancel</button>
            </div>
        </form>
    );
};
