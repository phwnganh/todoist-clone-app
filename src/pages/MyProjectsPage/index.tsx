    ...
    <>
      ...
      <section className="max-w-200 mx-auto w-full">
        <div className="flex flex-col gap-small">
          ...
          <p className="text-product-library-display-secondary-idle-tint px-1">
            Free
          </p>
          <div className="mt-2 flex items-center border border-product-library-border-idle-tint rounded-small">
            ...
            <div className="flex justify-between">
                ...
                <button className="px-3 h-8 flex items-center bg-product-library-actionable-secondary-idle-fill rounded-small">
            ...
            <button className="pt-3 flex justify-between pr-3 py-3">
                <div className="flex items-center">
